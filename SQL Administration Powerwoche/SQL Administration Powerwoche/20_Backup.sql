...
Welches Backup ist def das schnellste beim Restore?

V --> so oft wie möglich das V

Wie lange dauert das vorletzte T zum restoren?
V D TTTT

es dauert mind solange, wie die Anweisungen selbst dauert, die dort drin stecken
aber maximal nur solange, wie sicherungsintervalle sind
--> T Intervalle rel kurz



--DBOrig ------> DB_1215 lesbar
-- 100GB		 100GB  (Datei mit 100GB Größe)
--               auch wen nur 1MB frei sind
